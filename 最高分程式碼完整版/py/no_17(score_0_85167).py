# -*- coding: utf-8 -*-
"""No.17(score_0.85167).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/15Z-YSec2QOdgxBoQvRhXPs8aqnAgzm5W
"""
...
for fold, (train_idx, val_idx) in enumerate(skf.split(train_texts, train_labels), start=1):
    print(f"\n=== Fold {fold} ===")
...
"""**備註:報告中此版本採用上方投票方式推論，而下方加權方式則為先前版本，在此處僅作為參考用**"""
